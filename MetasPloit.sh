...
clear
toilet -f smslant -F gay 'METASPLOIT'
sleep 1
echo "\033[33;1m Metasploit Installer" "\033[37;1m From" "\033[36;1mIndonesia Security Lite"
sleep 1
echo "\033[31;1m CHANNEL : Lucifer Yt"

echo " "
echo "\033[36;1m=============================================================="
echo "\033[31;1m                 WARNING              "
sleep 1
echo "\033[31;1m1.PASTIKAN ANDA TIDAK PERNAH MENGINSTALL METASPLOIT"
sleep 1
echo "\033[31;1m2.ANDA HARUS TERHUBUNG DENGAN INTERNET"
sleep 1
echo "\033[31;1m3.PROSES PENGINSTALAN AGAK LAMA JADI MOHON BERSABAR"
sleep 1
echo "\033[31;1m4.PENYIMPANAN HARUS DI ATAS 300MB"
sleep 3
echo "\033[35;1m            WAIT..."
echo "\033[36;1m=============================================================="
read -p "Siap? [Y/T]=" LUCIFER
if [ $LUCIFER = Y ] || [ $LUCIFER = y ]
then
